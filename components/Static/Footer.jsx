...
export default function Footer({ $ }) {
    ...
    axios.get("https://award-demo.clquu.repl.co")
        .catch(() => {
            setApiAlive(false);
        }).then(res => {
            if (res) {
                ...
                <div className="pt-10 mx-auto">
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://award-demo.clquu.repl.co/v1/invite/discord" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    {$.footer.menus.first.items.support}
                                </a>
                            </div>
                            <div>
                                <a href="https://award-demo.clquu.repl.co/v1/invite/bot" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
